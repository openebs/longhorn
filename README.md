...
The host needs to have `docker` installed. Run the following command to make sure:
```
docker info
```
...
User need to make sure the host has `iscsiadm` installed. Run the following command to check:
```
iscsiadm --version
```
